...
--Date        : Tue Oct 24 12:24:46 2017
--Host        : IT002223 running 64-bit Service Pack 1  (build 7601)
--Command     : generate_target mysystem2_wrapper.bd
--Design      : mysystem2_wrapper
...
end mysystem2_wrapper;

architecture STRUCTURE of mysystem2_wrapper is
  component mysystem2 is
  port (
    ddr3_sdram_dq : inout STD_LOGIC_VECTOR ( 63 downto 0 );
    ddr3_sdram_dqs_p : inout STD_LOGIC_VECTOR ( 7 downto 0 );
    ddr3_sdram_dqs_n : inout STD_LOGIC_VECTOR ( 7 downto 0 );
  ...
  end component mysystem2;
begin
mysystem2_i: component mysystem2
    port map (
