...
proc create_ipi_design { offsetfile design_name } {
	...
	# Connect all clock & reset of axi_d_scheduler_0 slave interfaces..
	connect_bd_intf_net [get_bd_intf_pins axi_peri_interconnect/M00_AXI] [get_bd_intf_pins axi_d_scheduler_0/S_AXI_LITE]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/s_axi_lite_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/s_axi_lite_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]

	# Connect all clock & reset of axi_d_scheduler_0 streaming interfaces..
	connect_bd_net [get_bd_pins axi_d_scheduler_0/input_stream_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/input_stream_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/axis_join_switch_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/axis_join_switch_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/header_in_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/header_in_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/output_stream_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/output_stream_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/axis_split_switch_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/axis_split_switch_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/header_out_aclk] [get_bd_pins sys_clk_0/clk_out1]
	connect_bd_net [get_bd_pins axi_d_scheduler_0/header_out_aresetn] [get_bd_pins sys_reset_0/peripheral_aresetn]


	# Auto assign address
	assign_bd_address

	# Copy all address to axi_d_scheduler_v1_0_include.tcl file
	set bd_path [get_property DIRECTORY [current_project]]/[current_project].srcs/[current_fileset]/bd
	upvar 1 $offsetfile offset_file
	set offset_file "${bd_path}/axi_d_scheduler_v1_0_include.tcl"
	set fp [open $offset_file "w"]
	puts $fp "# Configuration address parameters"

	set offset [get_property OFFSET [get_bd_addr_segs /jtag_axi_0/Data/SEG_axi_d_scheduler_0_S_AXI_LITE_* ]]
...
set hw_test_file ${ip_path}/example_designs/debug_hw_design/axi_d_scheduler_v1_0_hw_test.tcl
...
for { set i 1 } { 1 } { incr i } {
	set design_name "axi_d_scheduler_v1_0_hw_${i}"
